...
public class RolePagingUtiles {
	...
	private int blockCount = 10; // 페이지 별 출력될 게시글 수
	private int blockPage = 5; // 페이지 별 출력될 페이지 넘버 수
	private int startPage; // 페이지 별 출력되 ㄹ페이지 넘버의 시작 번호
	private int endPage; // 페이지별 출력될 페이지 넘버으 ㅣ종료 번호
	...
	private void makePagination() {
		...
		// 페이지별 (10개 게시글, rownum번호 desc)
		this.startCount = this.totalCount - (this.currentPage - 1)
				* this.blockCount;
		...
		/*
		 * <ul class="pagination mtm mbm"> <li class="disabled"><a
		 * href="#">&laquo;</a></li> <li class="active"><a href="#">1</a></li>
		 * <li><a href="#">2</a></li> <li><a href="#">3</a></li> <li><a
		 * href="#">4</a></li> <li><a href="#">5</a></li> <li><a
		 * href="#">&raquo;</a></li> </ul>
		 */
